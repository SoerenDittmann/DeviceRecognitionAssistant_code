...
class RISErejectOption_entropy(RandomIntervalSpectralForest):
...
class RISErejectOption_rel_entropy(RandomIntervalSpectralForest): #calculate entropy relative to class_distribution
...
class RISErejectOption_proba(RandomIntervalSpectralForest): #threshold is not applied to entropy but to probability of highest class
